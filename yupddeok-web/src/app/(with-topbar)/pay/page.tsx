    ...
    <section>
     ...
     <div>
      ...
      <section>
        ...
        <label>
        <input
          type="radio"/>  1초 결제 </label>
        <label>
          <input
          type="radio"/>  신용/체크카드 </label>
        <label>
          <input
          type="radio"/>  카카오페이 </label>
          <label>
          <input
          type="radio"/>  네이버페이 </label>
           <label>
          <input
          type="radio"/>  페이코 </label>
           <label>
          <input
          type="radio"/>  삼성페이 </label>
           <label>
          <input
          type="radio"/>  만나서 결제 </label>

      </section>
      
       <Link href={`pay/orderCompleted`}>
      <button> 주문하기 </button>
      </Link>
</section>
);
